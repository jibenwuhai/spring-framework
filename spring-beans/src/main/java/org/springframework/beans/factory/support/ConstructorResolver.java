		...
		if (explicitArgs != null) {
			...
			synchronized (mbd.constructorArgumentLock) {
				...
				if (constructorToUse != null && mbd.constructorArgumentsResolved) {
					...
					if (argsToUse == null) {
						//如果resolvedConstructorArguments为空，则从缓存中获取准备用于解析的构造函数参数，constructorArgumentsResolved为true时，resolvedConstructorArguments和 preparedConstructorArguments必然有一个缓存了构造函数的参数
